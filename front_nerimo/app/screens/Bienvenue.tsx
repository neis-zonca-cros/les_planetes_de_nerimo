...
const Bienvenue: React.FC = () => {
  ...
  return (
    <View style={theme.container}>
      <Text style={theme.titreLarge}>Bienvenue sur les planètes de Nérimo !</Text>
      <TouchableOpacity
      ...
      <TouchableOpacity onPress={toggleTheme} style={theme.iconeContainer}>
        {theme === lightTheme ? (
          <View style={theme.iconeShadow}><LightThemeIcon width={80} background={theme === darkTheme ? "#23363E" : "#FAE6BB"}/></View>
        ) : (
          <View style={theme.iconeShadow}><DarkThemeIcon width={80} background={theme === darkTheme ? "#23363E" : "#FAE6BB"}/></View>
        )}
      </TouchableOpacity>
    </View>
  );
